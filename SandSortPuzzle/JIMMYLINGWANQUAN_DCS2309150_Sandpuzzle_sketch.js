...
function preload() {
    ...
    completeGif.hide();
    firstpage = loadImage('image-removebg-preview.png');
}
...
function drawStartScreen() {
    background(120);
    image(firstpage,width/2,(height/10)+240,200,200);
    push();
    fill(255);
    textFont(font);
    textSize(40);
    ...
    text('Select a Background to Start the Game', width / 2, (height / 4)+250);
    pop();

    //BUTTON 1
    var button1 = createButton('Landscape 1');
    button1.style('border', '2px solid #000000');
    button1.position((width / 3 - button1.width / 2)-60, (height / 2)+150);
    ...
    button2.position((width / 2 - button2.width / 2)-60, (height / 2)+150);
    ...
    button3.position((2 * width / 3 - button3.width / 2)-60, (height / 2)+150);
    button3.mouseOver(
        function() {
