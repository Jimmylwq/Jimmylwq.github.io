...
function drawStartScreen() {
    ...
    button1.mouseOver(
        function() {
            button1.style('border', '6px solid #b24d52'); // Change border color on mouseover
        }
    );
    button1.mouseOut(
        function() {
            button1.style('border', '2px solid #000000'); // Restore border color on mouseout
        }
    );
    ...
    button2.mouseOver(
        function() {
            button2.style('border', '6px solid #b24d52'); // Change border color on mouseover
        }
    );
    button2.mouseOut(
        function() {
            button2.style('border', '2px solid #000000'); // Restore border color on mouseout
        }
    );
